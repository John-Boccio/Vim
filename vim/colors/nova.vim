...
call s:HL("Number"         , s:amber         , ''              , s:bold)
...
" airline
call s:HL("Normal1"        , s:light_green   , s:selection , s:bold)
call s:HL("Normal2"        , s:inconspicuous , s:line      , s:none)
call s:HL("Normal3"        , s:foreground    , s:selection , s:none)
call s:HL("Insert1"        , s:red           , s:selection , s:bold)
call s:HL("Insert2"        , s:inconspicuous , s:line      , s:none)
call s:HL("Insert3"        , s:foreground    , s:selection , s:none)
call s:HL("Visual1"        , s:yellow        , s:selection , s:bold)
call s:HL("Visual2"        , s:inconspicuous , s:line      , s:none)
call s:HL("Visual3"        , s:foreground    , s:selection , s:none)
call s:HL("Replace1"       , s:deep_purple   , s:selection , s:bold)
call s:HL("Replace2"       , s:inconspicuous , s:line      , s:none)
call s:HL("Replace3"       , s:foreground    , s:selection , s:none)
call s:HL("Inactive1"      , s:foreground    , s:selection , s:bold)
call s:HL("Inactive2"      , s:inconspicuous , s:line      , s:none)
call s:HL("Inactive3"      , s:foreground    , s:selection , s:none)